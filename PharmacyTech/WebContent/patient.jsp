...
<body>
	...
	<div class="form-content">
		<form name=F1 onSubmit="return dil(this)" action="patientLogin.jsp">
			<table cellspacing="10" cellpadding="8">
				...
				%>
				<tr>
					<td colspan="2" class="form-heading">PATIENT LOGIN</td>
				</tr>
				<tr>
					<td>PATIENT NAME:</td>
				...
				<tr>
					<td><a href="RegisterPatient.jsp">New User</a></td>
				</tr>
			</table>
		</form>
	</div>
