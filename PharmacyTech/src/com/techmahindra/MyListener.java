...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		PreparedStatement ps6=con.prepareStatement("CREATE SEQUENCE Patient_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE");
		ps6.executeUpdate();
		
		PreparedStatement ps7=con.prepareStatement("CREATE TABLE  NEWPATIENT(ID NUMBER, PATIENT_NAME VARCHAR2(4000), DOCTOR_NAME VARCHAR2(4000), MADICINE_NAME VARCHAR2(4000), COST_OF_MADICINE NUMBER, QUANTITY NUMBER, AMOUNT NUMBER, REG_DATE VARCHAR2(4000), STAX NUMBER, TOT_AMOUNT NUMBER, PLACE VARCHAR2(4000), BILL_NUMBER VARCHAR2(4000), EMAIL VARCHAR2(4000),PRIMARY KEY (ID))");
		ps7.executeUpdate();
